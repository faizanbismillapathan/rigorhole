...
try {
    ...
    $mail->Username = 'enquiry@rigorhole.com'; // YOUR gmail email
    $mail->Password = 'xkpouvdqzvyuibmt'; // YOUR gmail password

    // Sender and recipient settings
    $mail->setFrom('enquiry@rigorhole.com', 'Clan 6');
    $mail->addAddress('fp7456209@gmail.com', 'Scientist Aamir'); // Get From User
